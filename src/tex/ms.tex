...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\columnwidth]{vae_loss_plot.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\columnwidth]{mmd_comparison.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\columnwidth]{posterior_check.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\columnwidth]{snr_vs_odds.png}
